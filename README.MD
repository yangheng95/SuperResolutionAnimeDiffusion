...
## Install 
1. Install [Anacona](https://www.anaconda.com/products/distribution) or [Miniconda](https://docs.conda.io/en/latest/miniconda.html)
...
python inference.py
```
see the soruce code for details, you can set scale factor to magnify pictures

## Random Examples
![Anime Girl](./random_examples/1.png)
![Anime Girl](./random_examples/2.png)
![Anime Girl](./random_examples/3.png)
![Anime Girl](./random_examples/4.png)
![Anime Girl](./random_examples/5.png)
![Anime Girl](./random_examples/6.png)
![Anime Girl](./random_examples/7.png)
# Origin README
---
language:
- en
